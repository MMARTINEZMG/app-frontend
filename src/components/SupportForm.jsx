...
const SupportForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setResponseMessage("Ocurrió un error al enviar tu solicitud. Por favor, inténtalo de nuevo.");
        }
    };
        ...
        <div className="min-h-screen flex justify-center items-center text-white">
            <div className="w-[40%] bg-[#1a1b1f] flex items-center justify-center py-12 rounded-lg">
                <div className="w-full max-w-md">
                    <h1 className="text-3xl font-bold mb-6 text-left text-[#d7d9dd]">Submit Support Request</h1>
                    <form onSubmit={handleSubmit}>
                        ...
                        <label className="block mb-4">
                            <span className="text-[#7d7a78] mb-2 block">Phone (optional)</span>
                            <input
                                type="text"
                                name="phone"
                                className="bg-[#212327] w-full p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6061df]"
